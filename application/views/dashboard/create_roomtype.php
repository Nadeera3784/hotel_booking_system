    ...
    <div class="container">
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Create room type</h5>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Create room type</span></li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Create room type</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        ...
                        <?php $attr = array("class" => "form-horizontal");?>
							<?php echo form_open('dashboard/create_roomtype', $attr);?>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label mb-10 col-sm-4" for="description">Facilities:</label>
                                        <div class="col-sm-8">
